...
router.get('/login', function(req, res, next) {
	...
	var encoded_scopes = encodedURIComponent(scopes);
	var encoded_uri = encodedURIComponent(redirect_uri);

/*
	res.redirect("https://accounts.spotify.com/authorize" + 
				 "?response_type=code" + 
				 "&client_id=" + my_client_id + 
				 (scopes ? "&scope=" + encoded_scopes : "") + 
...
router.get('/callback', function(req, res, next) {
	...
	.then(res => writeTokenFile( res.redirect(redirect_uri)))
